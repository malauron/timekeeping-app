    ...
    Private Sub TestConnection()
        ...
        Try
            ...
            Try
                ...
                mCommand.CommandText = "SELECT TABLE_SCHEMA FROM information_schema.TABLES WHERE TABLE_NAME ='EMPLOYEE_DTRS'"
                mReader = mCommand.ExecuteReader
                While mReader.Read
                    'cboDatabase.AddItem(CType(mReader.GetValue(mReader.GetOrdinal("database")), String))
                    cboDatabase.AddItem(CType(mReader.GetValue(mReader.GetOrdinal("TABLE_SCHEMA")), String))
                End While
                mReader.Close()
