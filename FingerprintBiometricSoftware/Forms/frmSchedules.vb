...
Public Class frmSchedules
            ...
            If NetOpen(dtSchedules, "select * from schedules where schedule_id=" & mSearchID) = True Then
                If dtSchedules.Rows.Count > 0 Then
                    ...
                    For Each drSchedule As DataRow In dtSchedules.Rows
                        ...
                        End If
                        chkFlexiBreak.Checked = CType(drSchedule.Item("flexibreak"), Boolean)
                    Next
                End If
            End If
        End If
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            End If
            If mSchedule_ID = 0 Then
                mCommand.CommandText = "insert into schedules (description,1st_insched,1st_outsched,2nd_insched,2nd_outsched,3rd_insched,3rd_outsched,flexibreak) values " & _
                                   "(@description," & m1stin & "," & m1stout & "," & m2ndin & "," & m2ndout & "," & m3rdin & "," & m3rdout & "," & CType(chkFlexiBreak.Checked, Integer) & ")"
            Else
                mCommand.CommandText = "update schedules set description=@description," & _
                                   ...
                                   "flexibreak=" & CType(chkFlexiBreak.Checked, Integer) & " " & _
    ...
    Private Sub chkFlexiBreak_MouseUp(sender As Object, e As System.Windows.Forms.MouseEventArgs) Handles chkFlexiBreak.MouseUp
        If chkFlexiBreak.Checked Then
            txt2nd_insched.Enabled = False
            txt2nd_outsched.Enabled = False
            txt3rd_insched.Enabled = False
            txt3rd_outsched.Enabled = False
        Else
            txt2nd_insched.Enabled = True
            txt2nd_outsched.Enabled = True
            txt3rd_insched.Enabled = True
            txt3rd_outsched.Enabled = True
        End If
    End Sub
End Class